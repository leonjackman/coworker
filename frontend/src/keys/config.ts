 ...
 * - Cmd+N   new chat, Cmd+Shift+N new project, Cmd+, settings
 * - Cmd+L   focus composer, Cmd+Enter send, Esc+Esc stop
 * - Cmd+B   sidebar, Cmd+\ right panel, Cmd+J bottom panel
 * - Cmd+/   cycle autonomy, Cmd+Shift+R regenerate, Cmd+Shift+E edit last user msg
 * - Cmd+1..5 view switching (providers / mcp / skills / memory / org)
 * - Esc     back to chat (single) / stop generation (double)
 * - Cmd+Shift+U attach, Cmd+Shift+C copy last response
 */
