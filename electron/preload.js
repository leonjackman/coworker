...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  getProjectDashboard: (projectId) => ipcRenderer.invoke('get-project-dashboard', projectId),
  getWorkspaceTree: (projectId, path = '') => ipcRenderer.invoke('get-workspace-tree', { projectId, path }),
  getWorkspaceDir: (projectId, path = '') => ipcRenderer.invoke('get-workspace-dir', { projectId, path }),
  getWorkspaceFile: (projectId, path) => ipcRenderer.invoke('get-workspace-file', { projectId, path }),
  getWorkspaceFilePreview: (projectId, path) => ipcRenderer.invoke('get-workspace-file-preview', { projectId, path }),
  ...
  listPendingSkills: () => ipcRenderer.invoke('list-pending-skills'),
  getPendingSkill: (name) => ipcRenderer.invoke('get-pending-skill', name),
  updatePendingSkill: (name, content) => ipcRenderer.invoke('update-pending-skill', name, content),
  approvePendingSkill: (name) => ipcRenderer.invoke('approve-pending-skill', name),
  rejectPendingSkill: (name) => ipcRenderer.invoke('reject-pending-skill', name),
  getMemoryStatus: () => ipcRenderer.invoke('get-memory-status'),
  discoverMemory: (projectId, scope = 'all') => ipcRenderer.invoke('discover-memory', { projectId: projectId || '', scope }),
  ...
  getWorkflowReviewSettings: () => ipcRenderer.invoke('get-workflow-review-settings'),
  saveWorkflowReviewSettings: (payload) => ipcRenderer.invoke('save-workflow-review-settings', payload),
  ...
  getMarketSkillDetail: (source, slug, owner) =>
    ipcRenderer.invoke('get-market-skill-detail', source, slug, owner ?? null),
